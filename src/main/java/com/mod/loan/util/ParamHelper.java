 ...
 * 参数接收类
 * 
 * @author wugy 2016年7月11日下午5:00:55
 *
 */
public class ParamHelper {
	...
	public static String expandStr(String _string, int _length, char _chrFill, boolean _bFillOnLeft) {
		...
		for (int i = 0; i < _length - nLen; i++)
			sRet = _bFillOnLeft ? (new StringBuilder(String.valueOf(_chrFill))).append(sRet).toString() : (new StringBuilder(String.valueOf(sRet))).append(
					_chrFill).toString();
