...
public class AddressListUtil {
	...
	//要过滤靠前显示的关键字
	public static String[] keyArr = new String[] { "爸", "妈", "爹", "娘", "父", "母", "公", "婆", "媳妇", "爱人", "太", "爷", "奶", "儿", "女", "兄", "弟", "姐", "妹", "嫂", "叔", "舅", "伯", "侄", "婶", "姨", "姑", "孙", "外甥", "贷", "中介", "口子", "还钱", "黑户", "代办", "养卡", "欠钱", "催", "金融", "假证", "套现", "钱", "借", "财富", "现金", "普惠", "宜信", "平安", "挖财", "呗", "51", "分期", "达飞", "信而富" };
