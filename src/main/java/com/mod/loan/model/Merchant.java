...
public class Merchant {
    ...
    public void setFuyou_merid(String fuyou_merid) {
        this.fuyou_merid = fuyou_merid == null ? null : fuyou_merid.trim();
    }
    ...
    public void setFuyou_secureid(String fuyou_secureid) {
        this.fuyou_secureid = fuyou_secureid == null ? null : fuyou_secureid.trim();
    }
    ...
    public void setFuyou_h5key(String fuyou_h5key) {
        this.fuyou_h5key = fuyou_h5key == null ? null : fuyou_h5key.trim();
    }
    ...
    public void setMerchantApp(String merchantApp) {
        this.merchantApp = merchantApp == null ? null : merchantApp.trim();
    }
    ...
    public void setHlb_id(String hlb_id) {
        this.hlb_id = hlb_id == null ? null : hlb_id.trim();
    }
    ...
    public void setHlb_rsa_public_key(String hlb_rsa_public_key) {
        this.hlb_rsa_public_key = hlb_rsa_public_key == null ? null : hlb_rsa_public_key.trim();
    }
    ...
    public void setHlb_md5_key(String hlb_md5_key) {
        this.hlb_md5_key = hlb_md5_key == null ? null : hlb_md5_key.trim();
    }
    ...
    public void setHlb_des_key(String hlb_des_key) {
        this.hlb_des_key = hlb_des_key == null ? null : hlb_des_key.trim();
    }
